...
@Disabled
public class AutoBotBlueSquareTwo extends OpModeCamera {
    ...
    public void loop() {
        ...
        switch (state) {
            ...
            case 1: // Going forwards.
                ...
                break;
            case 2: // Going on the long drive towards the beacon. This has the robot ramp down its power.
                ...
                break;
            case 3: // Drives forwards until it hits the button.
            ...
            case 7: // Backing up and launching ball.
                if ((getLeftPos() <= -480 * Constants.ENCODER_MULT) && (getRightPos() <= -480 * Constants.ENCODER_MULT)) {
                    left.setPower(0.0);
                    right.setPower(0.0);
