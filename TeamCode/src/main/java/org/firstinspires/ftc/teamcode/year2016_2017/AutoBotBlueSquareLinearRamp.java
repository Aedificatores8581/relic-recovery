...
@Autonomous(name = "Autonomous Blue Ramp", group = "Autonomous")
@Disabled
public class AutoBotBlueSquareLinearRamp extends OpModeCamera {
    ...
    public void loop() {
        ...
        switch (state) {
            ...
            case STATE_GOING_ON_ARC: // Going on the long drive towards the beacon.
                ...
                if (rightPos >= RIGHT_TARGET_DISTANCE * Constants.ENCODER_MULT * 1.2 / LEFT_SPEED_FACTOR) {
                    resetEncoders();
                    left.setPower(0);
                    right.setPower(0);
            ...
            case STATE_BACK_UP_TURN_AWAY_1B: // Turning away from the beacon.
                if (/*getLeftPos() >= 700 * Constants.ENCODER_MULT ||*/ getRightPos() >= 700 * Constants.ENCODER_MULT * 1.2) {
                    resetEncoders();
