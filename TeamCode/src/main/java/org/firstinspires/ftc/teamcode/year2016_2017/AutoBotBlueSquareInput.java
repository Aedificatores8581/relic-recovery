...
@Autonomous(name = "Autonomous Blue [Input]", group = "Autonomous")
//@Disabled
public class AutoBotBlueSquareInput extends OpModeCamera {
...
// Touch sensor is "ts1".
    ...
    int turnFromFirstBeacon = 620;
    int turnToSecondBeacon = 600;

    long beginningTime, runningTime;
    int color;

    double configArcFactor = 1.46;
    double configTurnPower = 1.24;
